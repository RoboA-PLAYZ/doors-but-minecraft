package net.mcreator.doorsbutminecraft;
...
public class DoorsButMinecraftMod implements ModInitializer {
	public static final Logger LOGGER = LogManager.getLogger(DoorsButMinecraftMod.class);
	public static final String MODID = "doors_but_minecraft";
